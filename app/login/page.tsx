        ...
        >
          ...
          <CardContent className="p-10 flex flex-col items-center relative z-20 overflow-hidden">
            ...
            <button
              ...
              className="w-full h-14 bg-white flex items-center justify-center gap-4 border border-slate-200 rounded-xl text-slate-700 font-bold hover:bg-blue-50/50 hover:border-blue-400 hover:text-blue-700 hover:shadow-md transition-all duration-300 group/btn relative overflow-hidden disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:bg-white disabled:hover:border-slate-200"
              aria-label="Sign in with Google"
            >
              <div className="absolute inset-0 bg-blue-50/0 group-hover/btn:bg-blue-50/50 transition-colors duration-300" />
              {isSigningIn ? (
                <Loader2 className="w-5 h-5 text-blue-500 animate-spin z-10" />
              ) : (
                <>
                  ...
                  <span className="z-10 tracking-tight">{isSigningIn ? 'Signing in...' : 'Sign in with Google'}</span>
                </>
              )}
            </button>
