 ...
 **Note**: Sheets sync may take 2-5 seconds. Refresh if needed.
 ...
 **Note**: Update should appear within 1-2 seconds
...
**Fix**: Check console for ` Realtime update received` - may need to disable realtime during save
